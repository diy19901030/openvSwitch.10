...
int get_odp_type();
struct tnl_port *tnl_find_exact(struct tnl_match *);

struct tnl_port *tnl_find_exact1(struct tnl_match *,uint16_t ofp_port);

uint16_t tnl_find2(const uint32_t odp_port, const char *ip_dst, int key);
