...
am__append_22 = utilities/bugtool/ovs-bugtool.8.in
am__append_23 = utilities/bugtool/ovs-bugtool.8
am__append_24 = $(bugtool_scripts)
am__append_25 = bugtool-install-data-local
am__append_26 = bugtool-uninstall-local
#am__append_27 = $(TESTPKI_FILES)
#am__append_28 = $(TESTPKI_FILES) tests/ovs-pki.log
#am__append_29 = clean-pki
am__append_30 = .h .hstamp
am__append_31 = $(HSTAMP_FILES)
am__append_32 = $(HSTAMP_FILES)
#am__append_33 = ovsdb/ovsdbmonitor/ovsdbmonitor
#am__append_34 = \
#	ovsdb/ovsdbmonitor/ovsdbmonitor \
#	ovsdb/ovsdbmonitor/ovsdbmonitor.tmp

#am__append_35 = ovsdb/ovsdbmonitor/ovsdbmonitor.1
subdir = .
...
am__lib_libopenvswitch_a_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/hmap.c lib/hmap.h lib/hmapx.c lib/hmapx.h lib/jhash.c \
	...
	lib/shash.c lib/shash.h lib/simap.c lib/simap.h lib/signals.c \
	lib/signals.h lib/smap.c lib/smap.h lib/socket-util.c \
	...
	lib/stream-unix.c lib/stream.c lib/stream.h lib/stress.c \
	lib/stress.h lib/string.c lib/string.h lib/svec.c lib/svec.h \
	lib/table.c lib/table.h lib/tag.c lib/tag.h lib/timer.c \
	lib/timer.h lib/timeval.c lib/timeval.h lib/token-bucket.c \
	...
	lib/vswitch-idl.h lib/worker.c lib/worker.h lib/dpif-linux.c \
...
am_lib_libopenvswitch_a_OBJECTS = lib/aes128.$(OBJEXT) \
	...
	lib/hmapx.$(OBJEXT) lib/jhash.$(OBJEXT) lib/json.$(OBJEXT) \
	...
	lib/ofp-version-opt.$(OBJEXT) lib/ofpbuf.$(OBJEXT) \
...
am__noinst_HEADERS_DIST = CodingStyle DESIGN FAQ INSTALL \
	...
	IntegrationGuide NOTICE OPENFLOW-1.1+ PORTING README-gcov \
	REPORTING-BUGS SubmittingPatches WHY-OVS boot.sh \
	build-aux/sodepends.pl build-aux/soexpand.pl lib/common.man \
	lib/common-syn.man lib/coverage-unixctl.man lib/daemon.man \
	lib/daemon-syn.man lib/leak-checker.man lib/memory-unixctl.man \
	...
	ofproto/ofproto-dpif-unixctl.man utilities/ovs-vlan-bugs.man \
	...
	ovsdb/ovsdbmonitor/ovsdbmonitor.1 lib/dh1024.pem \
	...
	tests/autopath.at tests/lacp.at tests/learn.at tests/vconn.at \
	tests/file_name.at tests/aes128.at tests/unixctl-py.at \
	tests/uuid.at tests/json.at tests/jsonrpc.at \
	tests/jsonrpc-py.at tests/timeval.at tests/tunnel.at \
	tests/lockfile.at tests/reconnect.at tests/ofproto-dpif.at \
...
ACLOCAL = ${SHELL} /home/vpls/openvswitch-1.10.0/build-aux/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/vpls/openvswitch-1.10.0/build-aux/missing --run tar
AUTOCONF = ${SHELL} /home/vpls/openvswitch-1.10.0/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/vpls/openvswitch-1.10.0/build-aux/missing --run autoheader
AUTOM4TE = ${SHELL} /home/vpls/openvswitch-1.10.0/build-aux/missing --run autom4te
AUTOMAKE = ${SHELL} /home/vpls/openvswitch-1.10.0/build-aux/missing --run automake-1.11
AWK = gawk
...
KARCH = 
KBUILD = /lib/modules/3.2.0-24-generic-pae/build
LDFLAGS = 
LIBOBJS = 
LIBS = -lpcap -lrt -lm 
LOGDIR = ${localstatedir}/log/${PACKAGE}
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/vpls/openvswitch-1.10.0/build-aux/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = openvswitch
PACKAGE_BUGREPORT = ovs-bugs@openvswitch.org
PACKAGE_NAME = openvswitch
PACKAGE_STRING = openvswitch 1.10.0
...
PYUIC4 = ${SHELL} /home/vpls/openvswitch-1.10.0/build-aux/missing --run pyuic4
RANLIB = ranlib
...
abs_builddir = /home/vpls/openvswitch-1.10.0
abs_srcdir = /home/vpls/openvswitch-1.10.0
abs_top_builddir = /home/vpls/openvswitch-1.10.0
abs_top_srcdir = /home/vpls/openvswitch-1.10.0
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/vpls/openvswitch-1.10.0/build-aux/install-sh
...
ALL_LOCAL = $(am__append_3) config-h-check rate-limit-check \
	check-assert-h-usage $(am__append_5) $(am__append_32) \
...
CLEANFILES = $(am__append_4) $(am__append_6) manpage-dep-check \
	...
	$(am__append_20) $(valgrind_wrappers) $(am__append_28) \
	$(am__append_31) vswitchd/vswitch.ovsschema.stamp \
	vswitchd/vswitch-idl.c vswitchd/vswitch-idl.h
CLEAN_LOCAL = clean-pycov $(am__append_29)
DISTCLEANFILES = utilities/ovs-appctl.8 utilities/ovs-ctl \
	...
	$(am__append_23) tests/atconfig tests/atlocal debian/copyright \
	vswitchd/ovs-vswitchd.8 ovsdb/ovsdb-tool.1 \
	ovsdb/ovsdb-client.1 ovsdb/ovsdb-server.1 ovsdb/ovsdb-idlc \
	ovsdb/ovsdb-doc ovsdb/ovsdb-dot $(am__append_34)
...
EXTRA_DIST = CodingStyle DESIGN FAQ INSTALL INSTALL.Debian \
	...
	IntegrationGuide NOTICE OPENFLOW-1.1+ PORTING README-gcov \
	REPORTING-BUGS SubmittingPatches WHY-OVS boot.sh \
	build-aux/sodepends.pl build-aux/soexpand.pl $(MAN_FRAGMENTS) \
	$(MAN_ROOTS) lib/dh1024.pem lib/dh2048.pem lib/dh4096.pem \
	lib/dirs.c.in $(srcdir)/lib/vswitch-idl.ann \
	...
	$(IDLTEST_IDL_FILES) tests/choose-port.pl $(CHECK_PYFILES) \
	build-aux/check-structs third-party/README \
	third-party/ofp-tcpdump.patch debian/changelog debian/compat \
	debian/control debian/control.modules.in debian/copyright \
	debian/copyright.in debian/dkms.conf.in debian/dirs \
...
dist_scripts_DATA = 
INSTALL_DATA_LOCAL = lib-install-data-local $(am__append_25)
UNINSTALL_LOCAL = $(am__append_26) ovsdbmonitor-uninstall-local \
	ovs-uninstall-local
# ovsdb-tool.1
# ovsdb-client.1
# ovsdb-server.1
...
MAN_FRAGMENTS = lib/common.man lib/common-syn.man \
	...
	lib/leak-checker.man lib/memory-unixctl.man \
	lib/ofp-version.man lib/ovs.tmac lib/ssl-bootstrap.man \
	lib/ssl-bootstrap-syn.man lib/ssl-peer-ca-cert.man lib/ssl.man \
	lib/ssl-syn.man lib/stress-unixctl.man lib/table.man \
	lib/unixctl.man lib/unixctl-syn.man lib/vconn-active.man \
...
MAN_ROOTS = utilities/ovs-appctl.8.in utilities/ovs-benchmark.1.in \
	...
	utilities/ovs-vlan-bug-workaround.8.in utilities/ovs-test.8.in \
	utilities/ovs-vlan-test.8.in utilities/ovs-vsctl.8.in \
	$(am__append_22) vswitchd/ovs-vswitchd.8.in \
	ovsdb/ovsdb-tool.1.in ovsdb/ovsdb-client.1.in \
	ovsdb/ovsdb-server.1.in ovsdb/ovsdb-idlc.1 \
...
scripts_SCRIPTS = utilities/ovs-check-dead-ifs utilities/ovs-ctl \
	utilities/ovs-save $(am__append_24)
scripts_DATA = utilities/ovs-lib
SUFFIXES = .in $(am__append_30) .ovsidl .ovsschema .ui .py
check_DATA = $(am__append_27)
...
lib_libopenvswitch_a_SOURCES = lib/aes128.c lib/aes128.h \
	...
	lib/vconn.h lib/vlan-bitmap.c lib/vlan-bitmap.h lib/vlandev.c \
	lib/vlandev.h lib/vlog.c lib/vlog.h lib/vswitch-idl.c \
	lib/vswitch-idl.h lib/worker.c lib/worker.h $(am__append_9) \
...
tests/test-heap.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test-heap$(EXEEXT): $(tests_test_heap_OBJECTS) $(tests_test_heap_DEPENDENCIES) tests/$(am__dirstamp)
...
tests/test-netflow.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test-netflow$(EXEEXT): $(tests_test_netflow_OBJECTS) $(tests_test_netflow_DEPENDENCIES) tests/$(am__dirstamp)
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	install-man8 install-nobase_pkgdataDATA \
	install-ovsdbmonitorDATA install-pdf install-pdf-am \
